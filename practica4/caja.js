...
// ============================== NUEVO ==============================
// Ahora agregarPedido espera a que cocina prepare el producto con una promesa.
async function agregarPedido(idProducto) {
    ...
    // ============================== NUEVO ==============================
    // Si no hay ingredientes o hay error en cocina, no se agrega el pedido.
    try {
...
async function menuCaja() {
    ...
    while (opcion !== "0") {
        ...
        if (opcion === "1") {
            ...
            // ============================== NUEVO ==============================
            await agregarPedido(idProducto);

...
function mostrarOpciones() {
    ...
    console.log("7. Ver productos baratos");
    console.log("8. Ver productos caros");
    console.log("9. Ver bebidas");
    console.log("10. Ver postres");
    console.log("0. Salir");
}


// Filtra productos baratos.
function filtrarProductosBaratos() {
    let productosBaratos = productos.filter(function(producto) {
        return producto.precio <= 70;
    });

    console.log("===== PRODUCTOS BARATOS =====");

    productosBaratos.forEach(function(producto) {
        console.log(
            producto.id + ". " +
            producto.nombre + " - $" +
            producto.precio + " - " +
